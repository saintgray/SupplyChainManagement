...
public interface BuyImportDAO {
	...
	public int returnInsert(Map<String, Object> paramMap);

	public int returnInsertDetail(Map<String, Object> paramMap);

	public void returnInsertDelivery(Map<String, Object> paramMap);
