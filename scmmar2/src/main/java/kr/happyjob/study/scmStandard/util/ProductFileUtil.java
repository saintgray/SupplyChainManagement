package kr.happyjob.study.scmStandard.util;
...
public class ProductFileUtil {
	...
	public ProductFileUtil(HttpServletRequest request, String rootFilePath, String virtualRootPath,
			String itemFilePath) {
		super();
	 ...
	 * @return 저장된 파일 메타 정보
	 */
	public List<ProductFileModel> uploadFiles() throws Exception {
		
		logger.info("   - uploadFiles() started ");
		
		// Return value
		List<ProductFileModel> listFileUtilModel = new ArrayList<ProductFileModel>();
        ...
        while(files.hasNext()){
            ...
            if (!multipartFile.isEmpty()) {
            	...
            	ProductFileModel fileModel = new ProductFileModel();
                ...
                logger.info("   - ProductFileUtil newFileName : " + newFileName);
                logger.info("   - ProductFileUtil ofileName : " + ofileName);
                
                 
                String dirFileName = File.separator + itemFilePath + ofileName; // /product/a.jpg
	 ...
	 * @throws Exception
	 */
	public void deleteFiles(List<ProductFileModel> listFileUtilModel) throws Exception {
		
		if (listFileUtilModel != null) {
			for(ProductFileModel fileUtilModel : listFileUtilModel) {
