...
public class UploadFileUtil {
	...
	public UploadFileUtil(HttpServletRequest request, String rootFilePath, String virtualRootPath,
			String itemFilePath) {
		super();
	 ...
	 * @return 저장된 파일 메타 정보
	 */
	public List<NoticeBoardModel> uploadFiles() throws Exception {
		
		logger.info("   - uploadFiles() started ");
		
		// Return value
		List<NoticeBoardModel> listFileUtilModel = new ArrayList<NoticeBoardModel>();
        ...
        while(files.hasNext()){
            ...
            if (!multipartFile.isEmpty()) {
            	...
            	NoticeBoardModel fileModel = new NoticeBoardModel();
	 ...
	 * @throws Exception
	 */
	public void deleteFiles(NoticeBoardModel listFileUtilModel) throws Exception {
		
		if (listFileUtilModel != null) {
				
			// 원본 파일 삭제
			String local_path = listFileUtilModel.getFile_local_path();
