...
<script type="text/javascript">
	...
	$(function() {
		...
		// 장비코드
		comcombo("proCD", "samplecombo", "sel");
		// 모델번호
		//selectGoodComCombo("m",  $("#samplecombo").val(), "", "goodmcombo", "sel");		
		// 제품번호
		//selectGoodComCombo("s",  $("#samplecombo").val(), $("#goodmcombo").val(), "goodscombo", "sel");			
		
		// 납품 거래처
		selectComCombo("cli", "samplecli", "sel");
		// 창고
	...
	function researchgood() {
		$("#goodscombo").find("option").remove();
		
		selectGoodComCombo("m",  $("#samplecombo").val(), "", "goodmcombo", "sel");	
	}	
	
	// 제품번호
	function researchmgood() {
		selectGoodComCombo("s",  $("#samplecombo").val(), $("#goodmcombo").val(), "goodscombo", "sel");			
	}		
					...
					<div class="content">
                        ...
                        <tr style="border: 0px; border-color: blue">
                           ...
                           <td width="50" height="25" style="font-size: 100%; text-align:left; padding-right:25px;">
     	                      장비코드 <select id="samplecombo" name="samplecombo" onchange="javascript:researchgood()"></select>
     	                      모델번호 <select id="goodmcombo" name="goodmcombo" onchange="javascript:researchmgood()"></select>
     	                      제품번호 <select id="goodscombo" name="goodscombo"></select>
     	                      납품 거래처<select id="samplecli" name="samplecli"></select>
     	                      창고<select id="samplewh" name="samplewh"></select>
