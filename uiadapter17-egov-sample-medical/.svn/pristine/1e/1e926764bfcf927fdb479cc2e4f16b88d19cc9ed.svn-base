...
import com.nexacro.sample.web.UserLogInController;
...
public class EgovSampleController {
	...
	public String selectSampleList(@ModelAttribute("searchVO") SampleDefaultVO searchVO, ModelMap model) throws Exception {
		...
		System.out.println(propertiesService.getInt("pageUnit"));
		System.out.println(propertiesService.getInt("pageSize"));
		
		System.out.println("www      " + searchVO);
