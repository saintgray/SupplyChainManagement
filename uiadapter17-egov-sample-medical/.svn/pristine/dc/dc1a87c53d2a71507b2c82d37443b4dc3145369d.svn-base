(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("grdTree","-5","196",null,null,"4","399",null,null,null,null,this.divLeft.form);
            obj.set_treeinitstatus("collapse,null");
            obj.set_autofittype("col");
            obj.set_treeusecheckbox("false");
            obj.set_cellsizingtype("col");
            obj.set_binddataset("dsMenu");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"247\"/></Columns><Rows><Row size=\"28\"/></Rows><Band id=\"body\"><Cell edittype=\"tree\" text=\"bind:menuNm\" treestartlevel=\"1\" treelevel=\"bind:level\" tooltiptext=\"bind:menuNm\" color=\"yellow\" font=\"bold 12px/normal &quot;Gulim&quot;\" displaytype=\"treeitemcontrol\"/></Band></Format></Formats>");
            this.divLeft.addChild(obj.name, obj);

            obj = new Grid("grdMyMenu","1","338",null,null,"-1","146",null,null,null,null,this.divLeft.form);
            obj.set_taborder("1");
            ...
            obj.set_cssclass("");
            obj.set_background("");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"231\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"메뉴명\"/></Band><Band id=\"body\"><Cell text=\"bind:menuNm\" textAlign=\"left\" padding=\"2px 2px 2px 10px\" color=\"red\" background=\"#293943\" font=\"bold 12px/normal &quot;Gulim&quot;\"/></Band></Format></Formats>");
            this.divLeft.addChild(obj.name, obj);
