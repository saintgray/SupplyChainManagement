if (nexacro.Environment)
{
    ...
    env.loadTypeDefinition = function ()
    {
        ...
        nexacro._addService("svcurl", "JSP", "http://localhost/uiadapter17-egov-sample/", "none", null, "", "0", "0");
        ...
        nexacro._addService("cop", "form", "./cop/", "session", null, "", "0", "0");
        ...
        var registerclass = [
        		...
        		{"id":"FileUpTransfer", "classname":"nexacro.VirtualFile", "type":"JavaScript"}
        ];
    ...
    {
        // Variables
        nexacro.setEnvironmentVariable("gvRunMode", "2");
        ...
        nexacro.setEnvironmentVariable("gvServerUrl", "http://localhost/uiadapter17-egov-sample/");
        nexacro.setEnvironmentVariable("gvUserType", "");
        nexacro.setEnvironmentVariable("loginYn", "N");
        nexacro.setEnvironmentVariable("modID", "");
