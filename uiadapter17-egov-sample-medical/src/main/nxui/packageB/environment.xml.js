if (nexacro.Environment)
{
    ...
    env.loadTypeDefinition = function ()
    {
        ...
        nexacro._addService("svcurl", "JSP", "http://localhost:8080/uiadapter17-egov-sample/", "none", null, "", "0", "0");
    ...
    env.on_loadVariables = function ()
    {
        ...
        nexacro.setEnvironmentVariable("gvServerUrl", "http://localhost/uiadapter17-egov-sample/packageB/");
