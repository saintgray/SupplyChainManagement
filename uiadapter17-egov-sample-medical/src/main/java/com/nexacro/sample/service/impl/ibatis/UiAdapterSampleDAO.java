...
public class UiAdapterSampleDAO extends NexacroIbatisAbstractDAO {
    ...
    public List<Map> testselect(Map<String,String> searchInfo) {
    	return (List<Map>) list("nexacroSample.testselect", searchInfo);
    }
    
    public void deletetest(Map<String,Object> sample) {
        delete("nexacroSample.deletetest", sample);
    }
    
    public void inserttest(Map<String,Object> sample) {
        insert("nexacroSample.inserttest", sample);
    }
    
    public void updatetest(Map<String,Object> sample) {
        update("nexacroSample.updatetest", sample);
    }
}
