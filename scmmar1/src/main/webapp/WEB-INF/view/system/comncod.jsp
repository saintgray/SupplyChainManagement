...
<script type="text/javascript">
	...
	$(function() {
		...
		// 상품 목록
		selectGoodComCombo("", "goodcombo", "sel");
	...
	function researchgood() {
		selectGoodComCombo($("#samplecombo").val(), "goodcombo", "sel");
	}
					...
					<div class="content">
                        ...
                        <tr style="border: 0px; border-color: blue">
                           ...
                           <td width="50" height="25" style="font-size: 100%; text-align:left; padding-right:25px;">
     	                      상품 구분 <select id="samplecombo" name="samplecombo" onchange="javascript:researchgood()"></select>
     	                      상품 <select id="goodcombo" name="goodcombo"></select>
