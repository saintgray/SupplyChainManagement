...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
		...
		<c:if test="${profitAndLossCnt > 0 }">
			...
			<c:forEach items="${profitAndLossList}" var="list">
				<tr>			
						<td onclick="fProfitAndLossOneBefore('${list.client}')">${list.client}</td>
        ...
        <input type="hidden" id="totcnt" name="totcnt" value="${profitAndLossCnt}"/>
