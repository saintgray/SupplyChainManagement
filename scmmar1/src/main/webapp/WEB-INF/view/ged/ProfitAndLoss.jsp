...
<script type="text/javascript">
	...
	function fListapplylist(currentPage) {
		...
		callAjax("/ged/profitAndLossList.do", "post", "text", true, param, resultCallback);
	}
	...
	function flistApplyResult(data, currentPage) {
		...
		// 기존 목록 삭제
		$('#divProfitAndLossList').empty();
		
		// 신규 목록 생성
		$("#divProfitAndLossList").append(data);
	...
	function fProfitAndLossOneBefore(client){
		$('#fProfitAndLossOneInput').val(client);
		fProfitAndLossOne(1);
	}
	
	
	/** 발주내역 한건 조회*/
	   function fProfitAndLossOne(currentPage) {
			currentPage = currentPage || 1;
		
	      var param = { 
	    		  client : $('#fProfitAndLossOneInput').val() 
	    		  , currentPage : currentPage
				    , pageSize : pageSize
	                  };
	      ...
	      var resultCallback = function(data) {
	         ...
	         fProfitAndLossOneResult(data,currentPage); 
	      };
	      callAjax("/ged/profitAndLossOne.do", "post", "text", true, param, resultCallback);
	   }
	   
	   /** 발주내역 한건 조회 콜백 */
	   function fProfitAndLossOneResult(data, currentPage) {
			
			//swal(data);
			//console.log(data);
			
			// 기존 목록 삭제
			$('#divProfitAndLoss').empty();
			
			// 신규 목록 생성
			$("#divProfitAndLoss").append(data);
			
			// 총 개수 추출
			
			var totcnt = $("#totProfitAndLossCnt").val();
			...
			var paginationHtml = getPaginationHtml(currentPage, totcnt, pageSize, pageBlock, 'fProfitAndLossOne');
			console.log("paginationHtml : " + paginationHtml);
			//swal(paginationHtml);
...
<div id="wrap_area">
    ...
    <input type="hidden" id="fProfitAndLossOneInput"  value=""/>
			...
			<li class="contents">
				<div class="content">
					...
					<p class="Location">
						...
						<span class="btn_nav bold">손익 조회</span> 
					...
					<table width="100%" cellpadding="5" cellspacing="0" border="1"
						...
						<div class="divProfitAndLossList">
							<table class="col">
								...
								<tbody id="divProfitAndLossList"></tbody>
							</table>
						...
						<div class="divProfitAndLoss">
							<table class="col">
								...
								<tbody id="divProfitAndLoss"></tbody>
							</table>
