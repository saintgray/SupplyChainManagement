...
public class SalesTopModel {
	...
	public SalesTopModel() {
		super();
		// TODO Auto-generated constructor stub
	}
	public SalesTopModel(int deliv_id, String purdate, String sales_Nm, int sell, String client, String from_date,
			String to_date) {
		super();
	...
	public String toString() {
		return "SalesTopModel [deliv_id=" + deliv_id + ", purdate=" + purdate + ", sales_Nm=" + sales_Nm + ", sell="
