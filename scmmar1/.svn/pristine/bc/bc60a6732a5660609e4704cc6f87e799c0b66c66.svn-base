...
public class dailyOrderHistoryModel {
	...
	public dailyOrderHistoryModel(int pur_id, String purdate, String name, String sales_nm, int price_sum, int price,
			int pur_cnt, int price_cnt, String returnYN, String wanted_date, String depositYN) {
		super();
		this.pur_id = pur_id;
