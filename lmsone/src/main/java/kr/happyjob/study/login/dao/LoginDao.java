...
public interface LoginDao {
	...
	public int registerCareer(List<Map<String, Object>> careerInfo) ;
	...
	public void deleteMember(List<String> paramList);

	public int searchTeacherInClass(List<String> paramList);
